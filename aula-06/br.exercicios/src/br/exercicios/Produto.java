/*
 * Produto.java + Loja.java — implemente a classe da seção 3 completa (validação de preço, estoque, venda) 
 * e escreva um main que testa todos os caminhos: preço inválido, venda maior que o estoque, venda válida;
 */
